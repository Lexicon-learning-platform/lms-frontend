    ...
    return (<>
        ...
        <div className='flex flex-row'>
            ...
            <aside className='flex flex-col w-1/4'>
                <div id="alterUser"
                     className="bg-slate-200 rounded-xl border border-slate-900 flex flex-col gap-6 p-6 m-6 h-auto">
                ...
                <div id="registering"
                     className="bg-slate-200 rounded-xl border border-slate-900 flex flex-col gap-6 p-6 m-6">

                    <input
                        className="w-auto bg-slate-100 border border-slate-700 rounded-lg p-2 focus:outline-none focus:border-emerald-500 m-1"
                        type="text" value={newUserName} onChange={(e) => setNewUserName(e.target.value)}
                        placeholder={"Namn"}/>
                    <input
                        className="w-auto bg-slate-100 border border-slate-700 rounded-lg p-2 focus:outline-none focus:border-emerald-500 m-1"
                        type="text" value={newUserPassword} onChange={(e) => setNewUserPassword(e.target.value)}
